...
const Index = () => {
  ...
  return (
    <div className="min-h-screen text-foreground overflow-x-hidden relative">
      <div className="fixed inset-0 bg-gradient-to-br from-primary/20 via-rose-500/10 to-background" />
      <div className="fixed inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,105,180,0.2),transparent_50%)]" />
      <div className="fixed inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(255,20,147,0.15),transparent_50%)]" />
      <div className="fixed inset-0 backdrop-blur-3xl opacity-50" />
      <StarryBackground />
      <FloatingHearts />
